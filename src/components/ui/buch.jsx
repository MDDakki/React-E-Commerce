  ...
  return (  
    <div className="buch">
      ...
      <div className="buch__ratings">
        {
          new Array(Math.floor(buch.rating)).fill(0).map((_, index) => <FontAwesomeIcon icon="star" key={index} />)
        }
        {
          !Number.isInteger(buch.rating) && <FontAwesomeIcon icon="star-half-alt" />
        }
      </div>
